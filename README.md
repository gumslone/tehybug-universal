...
Prefer a window? [`bugzapper.sh`](bugzapper.sh) launches **TeHyBug BugZapper**, a small Tkinter GUI
...
- [`bugzapper.sh`](bugzapper.sh) / [`tools/flashui.py`](tools/flashui.py) — GUI flasher + serial monitor
