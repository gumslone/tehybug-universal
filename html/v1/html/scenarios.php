...
<?php for ($i = 1; $i <= 3; $i++) { ?>
    <div class="col-lg-4 mb-4">
        <div class="card h-100">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_type" class="form-label">Type</label>
                    <select class="form-select" name="sc<?php echo $i; ?>_type" id="sc<?php echo $i; ?>_type" aria-label="Type">
                ...
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_url" class="form-label">URL</label>
                    <input type="url" class="form-control" id="sc<?php echo $i; ?>_url" minlength="7" placeholder="https://example.com Loading or no data" pattern="[Hh][Tt][Tt][Pp][Ss]?:\/\/(?:(?:[a-zA-Z\u00a1-\uffff0-9]+-?)*[a-zA-Z\u00a1-\uffff0-9]+)(?:\.(?:[a-zA-Z\u00a1-\uffff0-9]+-?)*[a-zA-Z\u00a1-\uffff0-9]+)*(?:\.(?:[a-zA-Z\u00a1-\uffff]{2,}))(?::\d{2,5})?(?:\/[^\s]*)?">
                    <small class="text-muted">Target URL for the HTTP GET / POST actions (ignored for the IO_13 actions).</small>
                </div>
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_message" class="form-label">Post Json (HTTP POST only)</label>
                    <input type="text" class="form-control" id="sc<?php echo $i; ?>_message" placeholder="Loading or no data">
                    <small class="text-muted">JSON body for HTTP POST — <code>%temp%</code> / <code>%humi%</code> are replaced with values.</small>
                </div>
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_data" class="form-label">Data</label>
                    <select class="form-select" name="sc<?php echo $i; ?>_data" id="sc<?php echo $i; ?>_data" aria-label="Data">
                ...
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_condition" class="form-label">Condition</label>
                    <select class="form-select" name="sc<?php echo $i; ?>_condition" id="sc<?php echo $i; ?>_condition" aria-label="Condition">
                ...
                <div class="mb-3">
                    <label for="sc<?php echo $i; ?>_value" class="form-label">Value</label>
                    <input type="text" class="form-control" pattern="[0-9]" id="sc<?php echo $i; ?>_value" placeholder="Loading or no value set">
                    <small class="text-muted">Threshold the reading is compared against.</small>
                </div>
                <div class="form-check form-switch">
                    <input type="checkbox" class="form-check-input" id="sc<?php echo $i; ?>_active">
                    <label class="form-check-label" for="sc<?php echo $i; ?>_active">active</label>
