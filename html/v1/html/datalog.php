        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning small mb-0">
                    <strong><span data-feather="alert-triangle"></span> Reading the log:</strong> the web interface is unavailable while offline. To read the stored data, press and release <strong>RESET</strong> (do <strong>not</strong> hold MODE during reset &mdash; that boots the ESP into flash mode), then while the LED glows <strong>orange</strong> (about 2 seconds in offline mode) press and hold <strong>MODE</strong> until the LED turns <strong>blue</strong> to re-enter config mode (WiFi on), and come back to this page.
                </div>
